...
public class MainActivity extends AppCompatActivity {
    ...
    private MessageRVAAdaptor messageRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messageRVAdapter = new MessageRVAAdaptor(messageModalArrayList, this);
    ...
    private void sendMessage(String userMsg) {
        ...
        String url = "http://api.brainshop.ai/get?bid=162445&key=eSSteQgWJNcuVNy8&uid=[uid]&msg=[msg]" + userMsg;
